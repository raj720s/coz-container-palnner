...
function UserPortCustomerMasterPage() {
  ...
  const masterSections: MasterSection[] = [
    {
      ...
      path: "/user/port-customer-master/pol-ports",
      count: 6,
      color: "bg-blue-500"
    },
    {
      ...
      path: "/user/port-customer-master/pod-ports",
      count: 6,
      color: "bg-green-500"
    },
    {
      ...
      path: "/user/port-customer-master/customers",
      count: 3,
      color: "bg-purple-500"
    }
  ];
    ...
    <div className="p-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Button
            variant="outline"
            onClick={() => router.push("/user/port-customer-master/pol-ports?action=add")}
          ...
          <Button
            variant="outline"
            onClick={() => router.push("/user/port-customer-master/pod-ports?action=add")}
          ...
          <Button
            variant="outline"
            onClick={() => router.push("/user/port-customer-master/customers?action=add")}
...
export default withSimplifiedRBAC(UserPortCustomerMasterPage, {
