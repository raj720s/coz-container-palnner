    ...
    <div className="p-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Button
            variant="outline"
            onClick={() => router.push("/admin/port-customer-master/pol-ports?action=add")}
          ...
          <Button
            variant="outline"
            onClick={() => router.push("/admin/port-customer-master/pod-ports?action=add")}
          ...
          <Button
            variant="outline"
            onClick={() => router.push("/admin/port-customer-master/customers?action=add")}
